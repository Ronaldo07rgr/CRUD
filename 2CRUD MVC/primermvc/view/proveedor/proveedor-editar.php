<div class="container">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active pl-3"><?php echo $pvd->nit != null ? $pvd->razonS : 'Nuevo Registro'; ?></li>
    </ol>
...
form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="dir" value="<?php echo $pvd->dir; ?>" class="form-control" place-
                holder="Ingrese dirección proveedor" data-validacion-tipo="requerido|min:100" />
        </div>
        <div class="form-group">
            <label>Teléfono</label>
            <input type="text" name="tel" value="<?php echo $pvd->tel; ?>" class="form-control" place-
